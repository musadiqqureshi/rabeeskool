-- RabeeSkool — run this ONCE in the SQL Editor of project ykzboawqgrqykrpeesaa
-- (your tables already have 0001-0003). Adds public academy read + Phase 3.
-- Direct link: https://supabase.com/dashboard/project/ykzboawqgrqykrpeesaa/sql/new
